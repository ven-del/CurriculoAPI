...
VALUES ('Wendell Pereira', 'Desenvolvedor Full Stack', 'Full Stack Developer', 'Desarrollador Full Stack', 'rwendell.regis@gmail.com', 'https://linkedin.com/in/ven-del', 'https://github.com/ven-del', '+55 (85) 997-017-021', 'Fortaleza, CE', 'Olá! Me chamo Wendell, sou apaixonado por tecnologia e nasci e cresci em Fortaleza. Tenho 5 anos de experiência em suporte e análise de sistemas, onde desenvolvi uma visão prática de monitoramento, rastreamento de falhas e comportamento de aplicações em produção. Atualmente sou desenvolvedor full-stack e professor de IA Generativa na Digital College, onde foco no ensino e aplicação prática de tecnologias emergentes. Fui aluno do projeto Geração Tech 2.0 e hoje tenho a honra de retribuir sendo responsável por uma das turmas da trilha de IA Generativa.', 'Hello, there! My name is Wendell, I am passionate about technology, and I was born and raised in Fortaleza. I have 5 years of experience in support and systems analysis, where I developed a practical perspective on monitoring, failure tracking, and application behavior in production environments. I am currently a full-stack developer and a Generative AI instructor at Digital College, where I focus on teaching and the practical application of emerging technologies. I was a student in the Geração Tech 2.0 project, and today I have the honor of giving back by being responsible for one of the classes in the Generative AI track.', '¡Hola! Me llamo Wendell, soy un apasionado de la tecnología y nací y crecí en Fortaleza. Tengo 5 años de experiencia en soporte y análisis de sistemas, donde desarrollé una visión práctica del monitoreo, el rastreo de fallas y el comportamiento de aplicaciones en entornos de producción. Actualmente soy desarrollador full-stack y profesor de IA Generativa en Digital College, donde me enfoco en la enseñanza y la aplicación práctica de tecnologías emergentes. Fui alumno del proyecto Geração Tech 2.0 y hoy tengo el honor de retribuir siendo responsable de una de las clases de la ruta de IA Generativa.');
